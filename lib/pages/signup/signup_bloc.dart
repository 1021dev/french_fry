...
class SignUpBloc with AppBloc {
  ...
  void initLogic() {
    eventBus.on().listen((value) {
      if (value == AppConstant.kNavigateConfirm) {
        // Navigator.of(context).push(TransparentSlideRoute(
        //     builder: (BuildContext context) => SignUpCodeScreen()));
        Navigator.push(
          context,
          PageTransition(
  ...
  PhoneCodeSent codeSent =
    ...
    eventBus.fire(AppConstant.kNavigateConfirm);
